// SherLock Email Config Tester (Internal)
...
if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
    console.error('❌ ERROR: Missing EMAIL_USER or EMAIL_PASS in .env');
    console.log('   Please open .env and add your Real Gmail App Password.');
    process.exit(1);
}
